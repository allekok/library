<?php
/* Run */
const main_css_path = "style.css";
const dark_css_path = "style-dark.css";

$main_css = file_get_contents(main_css_path);
$main_css = preg_replace_callback("/(#)([0-9a-f]+)(})/i",
...
function my_color_inverse($color) {
	...
	return isset($theme[$color]) ? $theme[$color] : color_inverse($color);
}
?>
